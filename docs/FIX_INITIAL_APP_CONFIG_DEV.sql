...
VALUES
  ...
  ('DEV', 'GITHUB_OWNER', 'CHO-Talents-Test', false, true, 'GitHub 저장소 owner 메타데이터'),
  ('DEV', 'GITHUB_REPO', 'CHO-Talents-Test', false, true, 'GitHub 저장소 이름 메타데이터'),
  ...
  ('DEV', 'SB_MANAGEMENT_ACCESS_TOKEN', 'env:SB_MANAGEMENT_ACCESS_TOKEN', true, false, '비밀 원문 저장 금지. Supabase Management API 실행 환경변수에 저장'),
