  ...
  history: [
    {
      version: '4.2.0',
      date: '2026-08-12',
      title: '추천 상품 투표 진행률 표시 개선',
      changes: [
        '추천 상품과 관리자 투표 화면에서 찬성·반대 방향별 집계 대신 과반 기준의 투표 진행률을 표시합니다.',
        '총 유효 투표 수가 등록 시점 과반에 도달하면 진행률은 100%로 표시됩니다.',
        '최고관리자는 관리자 투표 화면에서 기존 찬성·반대 집계를 계속 확인할 수 있습니다.'
      ]
    },
    {
      version: '4.1.0',
      date: '2026-08-11',
      title: '일요일 지정일 달란트 일괄 지급',
      changes: [
        '신규 월별 달란트 관리 화면에서 지급 항목과 대상·일요일을 선택한 뒤 한 번에 지급할 수 있습니다.',
        '거래에 실제 지급 대상일을 기록하고 같은 대상·항목·지급일만 중복 차단하도록 변경했습니다.',
        '기존 거래는 생성 시각의 한국 날짜를 지급일로 보정하며, 운영 DB에는 docs/TASK-099_scheduled_talent_grant_dates.sql 적용이 필요합니다.'
      ]
    },
    {
      version: '4.0.0',
      date: '2026-08-07',
      title: '사용자 통계 그래프 표시 순서 개선',
      changes: [
        '사용자 통계 그리드의 정렬 기준은 유지하면서 그래프 표시 순서를 별도로 적용했습니다.',
        '날짜별 그래프는 과거에서 현재 순, 요일별 그래프는 월요일에서 일요일 순, 시간별 그래프는 00:00에서 23:00 순으로 표시합니다.',
        '부서별 그래프는 1부, 2부, 3부, 4부, 5부, 예배부 순으로 표시합니다.'
      ]
    },
    {
      version: '3.99.0',
